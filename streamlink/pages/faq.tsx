    ...
    return(
        <div className='container'>
            ...
            <div className={styles.faqItem}>
                <FAQTitle title="What is StreamLink?"/>
                <Typography>StreamLink is a lightweight wallet designed to make transferring digital assets as easy as sending a link. 
                    Someone with solana can create a StreamLink and send that link to anyone over any platform (text, discord, email, etc). The amazing thing is, the link is the wallet!</Typography>
            </div>
            <div className={styles.faqItem}>
            ...
            <div className={styles.faqItem}>
                ...
                <Typography>We on our side do not store your StreamLinks. But, there are a couple handy approaches to recover them on your side.</Typography>
                <ol>
                    <li>Check your browser history. Remember, it’s just a URL, so it should be in there.</li>
                    <li>If you sent the StreamLink to someone, it should just be in whatever messaging platform you used.</li>
                    <li>More advanced features here coming soon.</li>
                </ol>
            </div>
            <div className={styles.faqItem}>
                <FAQTitle title="How to withdraw my StreamLink balance?"/>
            ...
            <div className={styles.faqItem}>
                ...
                <ul>
                    <li>Follow us on Twitter: @stream_protocol</li>
                </ul>
            </div>
        </div>
    );
