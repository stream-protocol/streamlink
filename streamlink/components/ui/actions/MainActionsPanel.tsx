...
import { DEFAULT_STREAMLINK_KEYLENGTH, SEED_LENGTH, randBuf, kdfz} from "../../../lib/crypto";
...
const MainActionsPanel = () => {
  ...
  const recreate = () => {
    ...
    // TODO refactor
    randBuf(DEFAULT_STREAMLINK_KEYLENGTH).then((b) => {
  ...
  return (
    <Box width="100%">
      ...
      <Box>
        ...
        <ActionsPanelRow
          icon={<IconRecreate />}
          title="Recreate this StreamLink"
          subtitle="Move the entire value to a new StreamLink so only you have the link."
        ...
        <ActionsPanelRow
          ...
          subtitle="Withdraw the entire value of this StreamLink."
