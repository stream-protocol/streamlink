...
const Main = () => {
  ...
  /*
  when you create a StreamLink from a StreamLink, we open the newly created link in a new tab
  ...
  */
  ...
  /*
  when you create a StreamLink with a balance from the front page, 
